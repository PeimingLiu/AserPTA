...
private:
    ...
    static std::tuple<const Args *...> evolveInnerContext(const HybridCtx<Args...> *prevCtx, const llvm::Instruction *I,
                                                          llvm::index_sequence<N...> sequence) {
...
public:
    ...
    HybridCtx(const HybridCtx<Args...> *prevCtx, const llvm::Instruction *I)
        : ctx(evolveInnerContext(prevCtx, I, llvm::index_sequence_for<Args...>{})) {}
...
struct hash<aser::HybridCtx<Args...>> {
    template <size_t... N>
    size_t hash_tuple(const aser::HybridCtx<Args...> &wrapper, llvm::index_sequence<N...> sequence) const {
    ...
    size_t operator()(const aser::HybridCtx<Args...> &wrapper) const {
        return this->hash_tuple(wrapper, llvm::index_sequence_for<Args...>{});
    }
};
